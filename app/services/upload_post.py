...
class UploadPostService:
    ...
    def __init__(self):
        self.api_key = get_config_value('app.upload_post_api_key', "")
        self.username = get_config_value('app.upload_post_username', "")
        self.enabled = get_config_value('app.upload_post_enabled', False)
        self.platforms = get_config_value('app.upload_post_platforms', ["tiktok", "instagram"])
        self.auto_upload = get_config_value('app.upload_post_auto_upload', False)
        self.youtube_privacy_status = get_config_value('app.upload_post_youtube_privacy_status', "public")
